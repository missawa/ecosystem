unit unt_cliente_atividade_apagar;
...
type
  Tfrm_cliente_atividade_apagar = class(Tfrm_cad_abstrato_mestre_detalhe)
    Label1: TLabel;
    edt_id: TwwDBEdit;
...
var
  frm_cliente_atividade_apagar: Tfrm_cliente_atividade_apagar;
...
procedure Tfrm_cliente_atividade_apagar.open_aux_queries;
begin
  Application.ProcessMessages;
end;

procedure Tfrm_cliente_atividade_apagar.btn_licencasClick(Sender: TObject);
begin
  abrir_licenca(
...
procedure Tfrm_cliente_atividade_apagar.dseAfterOpen(DataSet: TDataSet);
begin
  inherited;
...
procedure Tfrm_cliente_atividade_apagar.dseAfterScroll(DataSet: TDataSet);
begin
  inherited;
  mostra_cnpj_cpf
end;

procedure Tfrm_cliente_atividade_apagar.dse_detalheAfterOpen(DataSet: TDataSet);
begin
  inherited;
  carrega_combo_atividade(cmb_atividade);
end;

procedure Tfrm_cliente_atividade_apagar.dse_detalheNewRecord(DataSet: TDataSet);
begin
  inherited;
  dse_detalhe.FieldByName('id_cliente').AsInteger := dse.FieldByName(key_field).AsInteger;
end;

procedure Tfrm_cliente_atividade_apagar.FormCreate(Sender: TObject);
begin
  key_field := 'id';
...
procedure Tfrm_cliente_atividade_apagar.FormShow(Sender: TObject);
begin
  inherited;
...
procedure Tfrm_cliente_atividade_apagar.mostra_cnpj_cpf;
begin
